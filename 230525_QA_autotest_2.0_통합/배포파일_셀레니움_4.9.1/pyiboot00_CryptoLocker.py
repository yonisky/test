...
class Client_Test(unittest.TestCase):
    ...
    def test_040_pre_export_in_personal_drive(self):
        ...
        exist_export_drive = os.path.exists(find_drive('반출 보안 디스크')+exp_folder_name+'\\pre_export.txt') #cmp -> x , os.path 동일 실행
        self.assertTrue(exist_doc_export and exist_export_drive) #(True and True)
    ...
    def test_041_export_drive_when_cloudoc_login(self):
        ...
        try:
            ...
            pass
        self.assertTrue(export_drive!=None and read_permission and write_permission and delete_permission)
